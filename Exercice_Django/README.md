...
But de l'exercice candidat: ajouter une nouvelle ressource « Prescription » avec une API REST (lecture + création + mise à jour) et des possibilités de filtrage.
...
3) (Optionnel) Créer un superutilisateur

```bash
python manage.py createsuperuser
```

4) (Optionnel) Générer des données fictives
...
-----------------------------------
Objectif: créer une nouvelle ressource REST « Prescription » liée à 1 Patient et 1 Médicament.
...
- status: valeur parmi ["valide", "en_attente", "suppr"]
