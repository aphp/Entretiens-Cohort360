...
**Voir** → [`react/README.md`](./react/README.md) pour l'énoncé détaillé
...
**Voir** → [`django/README.md`](./django/README.md) pour l'énoncé détaillé
...
**Voir** → [`scala/README.md`](./scala/README.md) pour l'énoncé détaillé
...
| 2️⃣   | **Frontend**       | Obligatoire | ~1h30-2h      |
